...
namespace AutoyaFramework
{
    ...
    public partial class Autoya
    {
        ...
        */
        private void OnLoadProductsResponse(string responseData)
        {
            /*
        ...
        */
        private IEnumerator OnPurchaseReadyFailed()
            //(Purchase.PurchaseRouter.PurchaseReadyError err, int code, string reason, AutoyaStatus status)
        {
            // do something if need. 
            yield break;
        }
